 ...
 *******************************************************************************/
package org.web2017.redis.service.scheduler;

import com.google.common.collect.Lists;
import org.web2017.commons.Threads;
import org.web2017.redis.JedisScriptExecutor;
...
public class AdvancedJobConsumer {
  ...
  public AdvancedJobConsumer(String jobName, JedisPool jedisPool) {
    readyJobKey = org.web2017.redis.service.scheduler.Keys.getReadyJobKey(jobName);
    lockJobKey = org.web2017.redis.service.scheduler.Keys.getLockJobKey(jobName);
