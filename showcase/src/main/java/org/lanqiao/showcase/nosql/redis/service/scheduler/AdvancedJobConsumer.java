 ...
 *******************************************************************************/
package org.lanqiao.showcase.nosql.redis.service.scheduler;

import java.util.List;


import org.lanqiao.showcase.nosql.redis.JedisScriptExecutor;
import org.lanqiao.showcase.nosql.redis.JedisTemplate;
import org.lanqiao.showcase.nosql.redis.pool.JedisPool;
...
public class AdvancedJobConsumer {
	...
	public AdvancedJobConsumer(String jobName, JedisPool jedisPool) {
		readyJobKey = org.lanqiao.showcase.nosql.redis.service.scheduler.Keys.getReadyJobKey(jobName);
		lockJobKey = org.lanqiao.showcase.nosql.redis.service.scheduler.Keys.getLockJobKey(jobName);
